...
class CRM_Contract_Form_RapidCreate_AT extends CRM_Core_Form {
  ...
  function buildQuickForm() {
    ...
    $this->add('select', 'payment_frequency', ts('Payment Frequency'), CRM_Contract_RecurringContribution::getPaymentFrequencies());
  ...
  function setDefaults($defaultValues = null, $filter = null) {
    ...
    $defaults['cycle_day'] = CRM_Contract_PaymentAdapter_SEPAMandate::startDate([], $defaults['start_date'] ?? 'now')->format('d');
